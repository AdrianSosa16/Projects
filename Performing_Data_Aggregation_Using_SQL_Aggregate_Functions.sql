...
SELECT COUNT(emp_no) AS Num_employee FROM employees;
...
SELECT COUNT(first_name) AS first_count
FROM Employees;
...
SELECT COUNT(DISCTINCT first_name)
FROM employees;
